...
@if($products->isNotEmpty())
    ...
    <section id="Portfolio" class="content">
                ...
                <div id="filters" class="sixteen columns">
                    <ul class="clearfix">
                        ...
                        @foreach($categories as $category)
                            <li><a class="" href="#" data-filter=".category{{$category->id}}">
                                    <h5>{{$category->name}}</h5>
                                </a></li>
                        @endforeach
                    </ul>
        ...
        <!-- Portfolio Wrapper -->
            <div class="" style="position: relative; overflow: hidden; height: 480px;" id="portfolio_wrapper">
                <!--isotope fadeInLeft animated wow-->

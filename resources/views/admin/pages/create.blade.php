...
@section('content')
    ...
    <div class="wrapper container-fluid">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                {!! \Form::text('name',null,['class' => 'form-control','placeholder'=>'Введите название страницы'])!!}
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                {!! Form::text('alias',null,['class' => 'form-control','placeholder'=>'Введите псевдоним страницы']) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                {!! Form::textarea('text',null,['id'=>'editor','class' => 'form-control','placeholder'=>'Введите текст страницы']) !!}
            </div>
        </div>
